...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="tname" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">老师部门</span>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveTeacher.htm">
						<input type="hidden" name="tid" id="hidden_txt_userid" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>老师姓名:</td>
								<td><input type="text" id="tname" name="tname" class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>老师年龄:</td>
							...
							<tr>
							    <td>老师头像:</td>
								<td><input type="text" id="pic" name="pic" class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
								<td>老师部门: </td>
								<td>
	...
	function initEditUser(getSelection){
		$('#hidden_txt_userid').val(getSelection.tid);
		$('#tname').val(getSelection.tname);
