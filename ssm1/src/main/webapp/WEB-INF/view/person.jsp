	...
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="form-group col-lg-7">
                 <label class="col-sm-2 control-label">人员生日</label>
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_start" readonly="readonly" name="starttime" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间" id="txt_search_end" readonly="readonly" name="endtime" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>人员生日：</td>
								<td>
								<input id="birthday" name="birthday" class="laydate-icon form-control layer-date" aria-required="true" required/></td>
							</tr>
						</table>
